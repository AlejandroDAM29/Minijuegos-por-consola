...
public class Ahorcado{
    ...
    public void principal() {
        ...
        String arrayPalabras[] = new String[33];
        arrayPalabras[0] = "hola";
        arrayPalabras[1] = "adios";
        arrayPalabras[2] = "cojonudo";
        arrayPalabras[3] = "arte";
        arrayPalabras[4] = "morriña";
        arrayPalabras[5] = "guitarra";
        arrayPalabras[6] = "cadiz";
        arrayPalabras[7] = "malaga";
        arrayPalabras[8] = "huelva";
        arrayPalabras[9] = "granada";
        arrayPalabras[10] = "almeria";
        arrayPalabras[11] = "sevilla";
        arrayPalabras[12] = "cordoba";
        arrayPalabras[13] = "jaen";
        arrayPalabras[14] = "vigo";
        arrayPalabras[15] = "coruña";
        arrayPalabras[16] = "ourense";
        arrayPalabras[17] = "lugo";
        arrayPalabras[18] = "osiño";
        arrayPalabras[19] = "resurgir";
        arrayPalabras[20] = "constancia";
        arrayPalabras[21] = "perdon";
        arrayPalabras[22] = "confianza";
        arrayPalabras[23] = "olvidar";
        arrayPalabras[24] = "respeto";
        arrayPalabras[25] = "lugar";
        arrayPalabras[26] = "gofio";
        arrayPalabras[27] = "amigo";
        arrayPalabras[28] = "culpa";
        arrayPalabras[29] = "folias";
        arrayPalabras[30] = "baifo";
        arrayPalabras[31] = "baifo";
        arrayPalabras[32] = "pelete";
        
       
        do {
        
        // Desguazamos la palabra y la guardamos en un array de caracteres
        int alea = rnd.nextInt(32);
        ...
        System.out.println("Adiviña a palabra !. Ten 7 intentos de acertar antes de morrer o boneco "
        		+ "¿Serás o profesor que deixe morrer aos seus alumnos ou quen os salva? ");
        ...
        if(aciertos == tusRespuestas.length){
            System.out.print("\nImpediu que o pequeno galego morrese! Unha parte do mensaxe é: -4.888610");
            
        }
        // Si no otro
        else{
            System.out.print("\nEsgotáronse os intentos. Parece que o mensaxe oculto está resistíndote, ¿eh? hehe Será de novo ... A palabra foi:");
    ...
    public static char pregunta(String men, Scanner teclado) {
        ...
        resp = teclado.next().toLowerCase().charAt(0);
        while (resp != 's' && resp != 'n') {
            System.out.println("Erro! só se admite S ou N");
            resp = teclado.next().toLowerCase().charAt(0);
        }
        return resp;
    }
    ...
    private static void dibujar(int intentos) {
        switch (intentos) {
            ...
            case 6:
               System.out.println(" ---------------------");
                ...
                System.out.println("__________");
                System.out.println("GAME OVER - ¡SAIA DE GALICIA!");
                break;
        }
    }
}